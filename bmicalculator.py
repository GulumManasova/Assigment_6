...
class BMICalculator(QMainWindow):
    ...
    def get_bmi_status(self, bmi):
        if bmi < 18.5:
            return "Underweight: less than 18.5", "#FF6347"  # Red
        elif 18.5 <= bmi < 25:
            return "Normal: between 18.5 and 25", "#32CD32"  # Green
        elif 25 <= bmi < 30:
            return "Overweight: between 25 and 30", "#FFA500"  # Orange
        else:
            return "Obese: 30 or greater", "#FF0000"  # Dark Red
